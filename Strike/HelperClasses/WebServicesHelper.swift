...
enum webserviceUrl: String {
    ...
    case logIn = "/login",
         ...
         marvelfirststep = "/marvelfirststep",
         marvelaccoutpaymentnew = "/marvelaccoutpaymentnew",
    ...
    func url() -> String {
        ...
        case .accoutpaymentnew,.firststep,.checkcustidexistornot,.paymentMethods,.detatch,.updatepaymentmethod:
