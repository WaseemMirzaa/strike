...
//
//        self.view.backgroundColor = UIColor(gradientStyle: .topToBottom, withFrame: self.view.frame, andColors: [UIColor().colorsFromAsset(name: .bgColor),UIColor().colorsFromAsset(name: .bg1Color)])
//
//    }
