...
class HistoryViewController: UIViewController {
    ...
    func onloadDataSearch(){
        ...
        self.array.append(homeData(section: "Won Raffles", arrayData: array1))
        
        self.histroytableView.reloadData()
        self.histroytableView.reloadSections(NSIndexSet(index: 1) as IndexSet, with: .automatic)
    ...
    @IBAction func searchbnt(_ sender: Any) {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if issearch{
            ...
            case 2:
                ...
                let cell = tableView.dequeueReusableCell(withIdentifier: "historycellTableViewCell") as! historycellTableViewCell
                
                cell.woncollection.tag = 2
...
extension HistoryViewController:UICollectionViewDelegate,UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView.tag == 2{
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "WonHistoryCollectionViewCell", for: indexPath) as! WonHistoryCollectionViewCell
